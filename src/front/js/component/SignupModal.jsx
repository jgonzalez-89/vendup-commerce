        ...
        <Modal.Body>
            ...
            <Row>
              <Col xs={6} md={4}>
                <Button variant="primary" onClick={handleClose}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-facebook gap-between" viewBox="0 0 16 16">
          ...
          <Form>
            <Form.Group className="mb-2" controlId="exampleForm.ControlInput1">
              ...
              <Form.Control type="name" className="text" placeholder="Full Name" />
