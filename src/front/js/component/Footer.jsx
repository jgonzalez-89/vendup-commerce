...
const Footer = () => (
  ...
  <footer className="d-flex flex-wrap justify-content-between align-items-center">
    ...
    <ul className="nav col-md-4 justify-content-end">
      <li className="nav-item"><a href="/Terms" className="nav-link px-2 text-muted">Terms and Conditions</a></li>
      <li className="nav-item"><a href="/FAQs" className="nav-link px-2 text-muted">FAQs</a></li>
      <li className="nav-item"><a className="nav-link px-2 text-muted" href="/Team">
